...
def get_settings() -> dict:
    ...
    return {
        ...
        "google_location_name": _value(values, db_vals, "GOOGLE_LOCATION_NAME", "ROOTS - Organic Store and Juice Bar"),
        "google_logo_url": _value(values, db_vals, "GOOGLE_LOGO_URL", "https://roots.vn/images/favicon-180x180.png"),
        "google_rating": _value(values, db_vals, "GOOGLE_RATING", "4.5"),
        "google_review_count": _value(values, db_vals, "GOOGLE_REVIEW_COUNT", "220"),
